...
public class Status_receber_gesso extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Status_receber_gesso frame = new Status_receber_gesso();
	 ...
	 * Create the frame.
	 */
	public Status_receber_gesso() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Status_receber_gesso.class.getResource("/img/document_write_22637.png")));
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String sql ="select * from venda where status2=?";
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Status_receber_gesso.this.dispose();
			}
		});
		...
		JLabel lblPagamentoPorFornecedor = new JLabel("STATUS RECEBER GESSO");
		lblPagamentoPorFornecedor.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblPagamentoPorFornecedor.setBounds(253, 48, 222, 29);
