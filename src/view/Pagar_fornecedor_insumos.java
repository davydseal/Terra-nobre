...
public class Pagar_fornecedor_insumos extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Pagar_fornecedor_insumos frame = new Pagar_fornecedor_insumos();
	 ...
	 * Create the frame.
	 */
	public Pagar_fornecedor_insumos() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Pagar_fornecedor_insumos.class.getResource("/img/price-scan-scanner-bar-barcode-code_108573.png")));
		setTitle("Pagamento Fornecedor de Insumos");
		...
		try {
			...
			String s = "select * from cadastro_fornecedor_insumo";
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String sql ="select * from entrada_insumos where fornecedor=? and status2='EM ABERTO'";
					Connection con = Conexao.faz_conexao();
					//con = DriverManager.getConnection("jdbc:mysql://localhost/terra", "root", "");
					...
					while(set.next()) {
						...
						modelo.addRow(new Object[] {set.getString("fornecedor"), set.getString("mes"), set.getString("insumo"), set.getString("qtd"), set.getString("valor"), set.getString("total"), set.getString("data_vencimento"), set.getString("status2"), set.getString("data"), set.getString("nf")});
					}
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				table.setModel(new DefaultTableModel (null, new String [] {"Fornecedor","Mês Vencimento","Insumos","Quantidade","R$ Unitário","R$ Total","Data Vencimento","Status","Data do Pagamento","Nº Nota Fiscal"}));
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Pagar_fornecedor_insumos.this.dispose();
			}
		});
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Fornecedor", "M\u00EAs Vencimento", "Insumos", "Quantidade", "R$ Unit\u00E1rio", "R$ Total", "Data Vencimento", "Status", "Data do pagamento", "N\u00BA Nota Fiscal"
			}
		) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					while(set.next()) {
						...
						modelo.addRow(new Object[] {set.getString("fornecedor"), set.getString("mes"), set.getString("insumo"), set.getString("qtd"), set.getString("valor"), set.getString("total"), set.getString("data_vencimento"), set.getString("status"), set.getString("data"), set.getString("nf")});
					}
		...
		button_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				table_1.setModel(new DefaultTableModel (null, new String [] {"Mês Vencimento","Data Vencimento","Fornecedor","Insumos","Quantidade","R$ Unitário","R$ Total","Status","Data do Pagamento","Nº Nota Fiscal"}));
		...
		table_1.setModel(new DefaultTableModel(
			...
			new String[] {
				"M\u00EAs Vencimento", "Data Vencimento", "Fornecedor", "Insumos", "Quantidade", "R$ Unit\u00E1rio", "R$ Total", "Status", "Data do Pagamento", "N\u00BA Nota Fiscal"
			}
		) {
			boolean[] columnEditables = new boolean[] {
				false, false, false, false, false, false, false, false, false, false
		...
		tabbedPane.addTab("Insumos", null, panel_2, null);
		...
		JLabel lblMatriaPrima = new JLabel("Insumos");
		...
		try {
			...
			while(rs.next()){
				comboBox_2.addItem(rs.getString("insumo"));
			}
		...
		button_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String sql ="select * from entrada_insumos where insumo=?";
					Connection con = Conexao.faz_conexao();
					//con = DriverManager.getConnection("jdbc:mysql://localhost/terra", "root", "");
					java.sql.PreparedStatement statement = con.prepareStatement(sql);
		...
		button_9.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				table_2.setModel(new DefaultTableModel (null, new String [] {"Insumos","Data Vencimento","Fornecedor","Mês Vencimento","Quantidade","R$ Unitário","R$ Total","Status","Data do Pagamento","Nº Nota Fiscal"}));
		...
		JLabel lblPagamentoPorInsumos = new JLabel("PAGAMENTO POR INSUMOS");
		lblPagamentoPorInsumos.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblPagamentoPorInsumos.setBounds(238, 48, 252, 29);
		panel_8.add(lblPagamentoPorInsumos);
		...
		table_2.setModel(new DefaultTableModel(
			...
			new String[] {
				"Insumos", "Data Vencimento", "Fornecedor", "M\u00EAs Vencimento", "Quantidade", "R$ Unit\u00E1rio", "R$ Total", "Status", "Data do Pagamento", "N\u00BA Nota Fiscal"
			}
		) {
			boolean[] columnEditables = new boolean[] {
				false, false, false, false, false, false, false, false, false, false
